...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='output/step2')
    parser.add_argument('--save_path', default='output/step3')
    # prepare directory
    args = parser.parse_args()
    data_path = os.path.join(args.root_dir, args.data_path)
